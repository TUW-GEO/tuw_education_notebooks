...
[![](https://img.shields.io/badge/launch-jupyter-blue)](https://mybinder.org/v2/gh/tuw-geo/tuw_education_notebooks/fa8db7b74e6cffcdebbf2f713eccb2c6f63ca110?urlpath=lab%2Ftree%2F01_notebook_as_an_app.ipynb)
...
This last step is more subjective and relates to the psychology of colors: the multiple meanings and feelings that people associate with a color. Here we use a monotonic color gradient developed by TU Wien that transitions from brown for dry soils to blue for wet soils.
...
In this last rendition of the maps we have a nice monotonic relation between color and soil moisture, where the brown color evokes images of dried-out soils and the blues of water saturated conditions.
